...
class Nonexistence(Exception):
    def __init__(self, message: str = 'The term you have searched for does not exist in RuneScape 3. It may have never existed, or was added to RuneScape before the August 2007 Archive of RuneScape, which Old School RuneScape was based on, and has not been replicated.\n\nIf you are searching for a future update, please look for it at [upcoming updates](https://oldschool.runescape.wiki/w/Upcoming_updates) or create an article about it, supplying definite sources and citations.'):
